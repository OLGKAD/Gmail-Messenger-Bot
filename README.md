...
1. The ["database"](https://github.com/OLGKAD/Gmail-Messenger-Bot/master/mailbotapp/database) folder contains MySQL functions, and "database.py" - a python API for interactions with the DB. 
